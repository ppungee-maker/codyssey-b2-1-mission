...
> 구성한 참고 예시. 미션 원문은 [`problem.md`](problem.md) 참고.
...
| 파일 형식 PNG/JPG | PNG | ✅ |
| 작업 로그 문서 1개(프롬프트 기록) | [`worklog.md`](worklog.md) | ✅ |
...
| 프롬프트 개선 과정 문서 기록 | `worklog.md` 화면별 초안→최종 | ✅ |
